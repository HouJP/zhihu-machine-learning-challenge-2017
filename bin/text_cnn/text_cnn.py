...
def init_text_cnn(config):
    ...
    fs_word_share_length = config.getint('TITLE_CONTENT_CNN', 'fs_word_share_length')
    ...
    model = TitleContentCNN(title_word_length=title_word_length,
                            ...
                            fs_word_share_length=fs_word_share_length,
                            class_num=class_num,
...
class TitleContentCNN(object):
    def __init__(self,
        ...
        self.fs_word_share_length = fs_word_share_length
        ...
        fs_word_share_emb = Dense(128, activation='relu')(fs_word_share_input)
        title_content_features.append(fs_word_share_emb)
        ...
        self._model = Model([title_word_input, cont_word_input, title_char_input, cont_char_input, fs_btm_tw_cw_input, fs_word_share_input], preds)
