...
class TitleContentCNN(object):
    def __init__(self,
        ...
        title_content_features_conv = Dropout(0.5, name='title_content_features_conv_drop')(title_content_features_conv)
        ...
        # Prediction
        preds = Dense(class_num, name='prediction')(title_content_features)
        ...
        if 'rmsprop' == optimizer_name:
            ...
            optimizer = None
        self._model.compile(loss=matrix_pair_hinge_with_2side_top(top_k_pred = 20, top_k_true = 5), optimizer=optimizer, metrics=metrics)
        self._model.summary()
        self._model.load_weights('/home/yht/fanyixing/zhihu-machine-learning-challenge-2017/data/pretrained/text_cnn_v101_519.h5')
