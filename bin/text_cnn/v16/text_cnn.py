#!/usr/bin/python
# -*- coding: utf-8 -*-
# @Time    : 7/25/17 9:29 AM
# @Author  : Jianpeng Hou
# @Email   : houjp1992@gmail.com


"""
Change btm feature structure.
...
class TitleContentCNN(object):
    def __init__(self,
        ...
        # Full connection
        title_content_features = Dense(3600, activation='relu', name='fs_embedding_1')(title_content_features)
        title_content_features = Dropout(0.5, name='fs_embedding_dropout_1')(title_content_features)
        ...
        title_content_features = concatenate([title_content_features, fs_btm_tw_cw_input, fs_btm_tc_input])

        # Full connection
        title_content_features = Dense(3600, activation='relu', name='fs_embedding_2')(title_content_features)
        title_content_features = Dropout(0.5, name='fs_embedding_dropout_2')(title_content_features)
